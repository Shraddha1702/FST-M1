...
public class Activity2 {
    ...
    public void addNewUserFromFile() throws IOException {
        // Import JSON file
        FileInputStream inputJSON = new FileInputStream("src/resources/userinfo.json");
        ...
        response.then().body("message", equalTo("1702"));
    }
    
    @Test(priority=2)
    public void getUserInfo() {
        // Import JSON file to write to
        File outputJSON = new File("src/userGETResponse.json");
        ...
        // Assertion
        response.then().body("id", equalTo(1702));
